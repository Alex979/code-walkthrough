...
function validateChapters(value: unknown, steps: unknown[], errors: Problems): void {
  if (!Array.isArray(value) || value.length === 0) {
    errors.add(
      "lesson.chapters: expected a nonempty array; omit chapters for an ungrouped lesson.",
    );
    return;
  }
